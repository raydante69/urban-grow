...
import { LayoutDashboard, Users, ClipboardList, FolderOpen, School } from "lucide-react";
import { teacherNav } from "../data";

const icons = { LayoutDashboard, Users, ClipboardList, FolderOpen, School } as const;
                    ...
                    <>
                      <span
                        className={`flex h-9 w-9 items-center justify-center rounded-2xl transition-all ${
                          isActive ? "bg-sky/15 scale-105" : "bg-transparent"
                        }`}
                      >
